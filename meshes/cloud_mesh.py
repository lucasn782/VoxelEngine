    ...
    def build_mesh(cloud_data):
        ...
        for z in range(depth):
            for x in range(width):
                ...
                # encontre o número de quadrantes contínuos ao longo de x
                x_count = 1
                ...
                # encontre o número de quadrantes contínuos ao longo de z para cada x
                z_count_list = []
                ...
                # encontre a contagem mínima z para formar um grande quadrante
                z_count = min(z_count_list) if z_count_list else 1

                # marcar todos os quadrantes unitários do quadrante grande como visitados
                for ix in range(x_count):
