...
const float face_shading[6] = float[6](
    1.0, 0.5, // de cima para baixo
    0.5, 0.8, // direita esquerda
    0.5, 0.8 // frente trás
);
...
const int uv_indices[24] = int[24](
    1, 0, 2, 1, 2, 3, // índices de coordenadas de textura para vértices de uma face uniforme
    3, 0, 2, 3, 1, 0, // face ímpar
    3, 1, 0, 3, 0, 2, // face par invertida
    1, 2, 3, 1, 0, 2  // face ímpar invertida
...
void unpack(uint packed_data) {
    ...
    // descompactando dados de vértice
